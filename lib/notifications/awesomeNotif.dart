...
class NotificationController {
  ...
  static Future<void> initializeLocalNotifications({required bool debug}) async { ///main_call
    await AwesomeNotifications().initialize(
        'resource://drawable/ic_notif_belaaraby',//null,
        [
          NotificationChannel(
              channelKey: 'alerts',
  ...
  static Future<void> createNewStoreNotification(String title,String body) async {
    ...
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            ...
            largeIcon: 'https://play-lh.googleusercontent.com/rPUwEwddo9APN5BDliQT5q26f4dzlD3hc6scu-98Dr0KAShkbCVwS8o9GRfGo5BGjg=w240-h480-rw',
